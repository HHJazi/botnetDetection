...
namespace Biotracker.Client.ProcessMonitor
{
    ...
    public class PairNodeFeature
    {
        ...
        ///// <summary>
        /////list of all flows within a pair of nodes
        ///// </summary>
        [DataMember]
        public int NofFlows
        {
        ...
        [DataMember]
        public double ConnectionDegree
        {
            get;
            set;
        }
        ...
        public string featuresToString()
        {
            ...
            features += SrcMAC2 + "," + DestMAC2 + "," + SrcIP2 + "," + DestIP2 + "," 
            //    + SrcPort.ToString() + "," + DestPort.ToString() + "," + Protocol.ToString() + "," + TBT.ToString() + "," + FPS.ToString() + "," +
             //   APL.ToString() + ","  + AB.ToString()+ "," + BS.ToString()+ "," + PS.ToString()+ "," + DPL.ToString() + "," +PPS.ToString()+ "," + PV.ToString()+ "," + PX.ToString()+ "," +
          //  NNP.ToString() + "," + NSP.ToString() + "," + PSP.ToString() + "," + Duration.ToString()+","
            +this.Type.ToString();
